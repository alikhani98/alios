...
On 2026-07-17, the Stage 84 production build emitted a 550.15 kB primary entry. Stage 85 emits a 239.01 kB primary entry, a 208.17 kB React vendor chunk, and a 36.78 kB icon vendor chunk. The 82.28 kB forms vendor chunk is no longer module-preloaded by `index.html`.
...
1. Run `pnpm build` and confirm no Vite chunk-size warning is emitted.
