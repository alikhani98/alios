...
- Long Finance collections may apply local presentation-only reveal boundaries; calculations, filters, forms, CRUD actions, and repository queries continue to operate on the complete filtered record set
