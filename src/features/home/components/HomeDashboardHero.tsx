...
export function HomeDashboardHero({ data, actions }: HomeDashboardHeroProps) {
  ...
  return (
    <PremiumCard className="overflow-hidden border-primary/20 bg-card shadow-md">
      <CardContent className="p-0">
        <div className="grid xl:grid-cols-[minmax(0,1.35fr)_minmax(19rem,0.65fr)]">
          <div className="p-5 sm:p-6 xl:border-e xl:border-primary/10">
            <div className="rounded-[1.75rem] border border-primary-foreground/10 bg-gradient-to-br from-primary via-primary to-primary/90 p-5 text-primary-foreground shadow-lg sm:p-6">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <Badge
                  className="border-primary-foreground/20 bg-primary-foreground/15 px-3 py-1 text-primary-foreground hover:bg-primary-foreground/15"
                  variant="outline"
                >
              ...
              <p className="mt-6 break-words text-2xl font-semibold leading-9 sm:text-[2rem]">
                {mitLabel}
              </p>
              ...
              <div className="mt-6 space-y-4">
                <MiniProgressBar
                  ...
                  className="[&>div:last-child]:bg-primary-foreground/20 [&>div:last-child>div]:bg-primary-foreground"
                />
                <div className="flex flex-wrap gap-2">
                  <span className="rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-3 py-1.5 text-xs font-medium">
                    {checkinSummary}
                  </span>
                  <span className="rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-3 py-1.5 text-xs font-medium">
                    {t("home.completedTasks")}: {completedCount}
              ...
              <div className="mt-7 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
                <Button asChild variant="secondary" className="min-h-11 w-full bg-primary-foreground text-primary shadow-sm hover:bg-primary-foreground/90 sm:w-auto">
                  <Link to="/today">
                ...
                <Button
                  asChild
                  variant="ghost"
                  className="min-h-11 w-full border border-primary-foreground/15 bg-primary-foreground/5 text-primary-foreground hover:bg-primary-foreground/12 hover:text-primary-foreground sm:w-auto"
                >
                  <Link to="/inbox">
          ...
          <div className="border-t border-primary/10 p-5 sm:p-6 xl:border-t-0">
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 min-[400px]:grid-cols-2">
              {heroMetrics.map((metric) => (
                <SoftPanel
                  key={metric.label}
                  className="min-w-0 space-y-3 border-primary/10 bg-muted/30 p-4"
                >
