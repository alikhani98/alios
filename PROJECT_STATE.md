...
`feat(life-areas): add local life areas foundation`
...
- Production build warning: Vite reported a chunk-size warning for the main bundle
- Automated test count: 708 passing across 39 suites
