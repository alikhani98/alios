...
Stages 74–77 add pull-request validation, Life Areas QA, derived Goals ↔ Life Areas navigation, and release hardening for the combined track without changing AliOS's local-only architecture.
